...
import com.example.demo_fit.databinding.UpdatePasswordBinding
...
class UpdatePassword : AppCompatActivity() {
    ...
    private lateinit var mBinding: UpdatePasswordBinding
    private lateinit var auth: FirebaseAuth

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        mBinding = UpdatePasswordBinding.inflate(layoutInflater)
